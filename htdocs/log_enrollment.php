            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form action="log_view_detail.php" method="POST">
                    <br />
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align:right; " >공지명</label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" class="form-control" name = "noti_name" placeholder="공지명을 입력하세요." style="margin-bottom: 10px; width:90%;">
                      </div>
                    </div>
                    

                    <div class="form-group" style="margin-bottom: 15px;" >
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align:right; ">공지 내용</label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <textarea class="form-control" rows="20" name = "noti_text" placeholder="공지사항을 입력하세요." style="resize: none; width:90%;"></textarea>
                      </div>
                    </div>
                    
                  <button type="submit" class="btn btn-success" onclick="alert('등록하시겠습니까?'); location.href='log_view_detail.php';" style="float:right; margin-top:10px;">등록</button>
