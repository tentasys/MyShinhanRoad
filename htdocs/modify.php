...
$con = mysqli_connect("192.168.1.156", "root", "",'shinple') or die (mysql_error()); 
    ...
    for($i=0; $i<=4; $i++){
        ...
        $course_num = [1,2,3,4,5][$i];     // ComName(회사명)을 POST 방식으로 받습니다. 
		...
		$sql = "UPDATE problem SET problem_answer='$problem_answer',problem_txt=$problem_txt, problem_no1=$problem_no1, problem_no2=$problem_no2, problem_no3=$problem_no3, problem_no4=$problem_no4;";
