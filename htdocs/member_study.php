...
<html lang="en">
  ...
  <?php
    ...
    $query = "SELECT c.course_title, COUNT(*), c.course_num FROM (select a.course_title, b.course_num 
    from course a right outer join learn_course b on a.course_num = b.course_num) c
          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>강좌 List <small>수강 인원 선택 시 회원 정보를 확인 할 수 있습니다. </small> </h2>
                    <div class="clearfix"></div>
                  </div>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings" style="text-align:center;">
                            ...
                            <th class="column-title" style="text-align:center;">수강 인원</th>
                ...
                ?>                      <tr class="odd pointer" style="text-align:center;">
                    ...
                    <td class=" "><?php echo $rows['course_title']?></a></td>
                    <td>
                      <form action="member_study_detail.php" method="POST">
                        <input id="keys_1" type="hidden" name="key_1" value =<?php echo $rows['course_num'] ?> > 
                        <button type="submit" class="btn btn-success" style="float:center; background-color:rgba(255,255,255,0); color:#73879C; border:none; padding:0px; margin:0px;" hover="rgba(255,255,255,0)";><?php echo $rows['COUNT(*)'];?></button>
                    </form>
                    </td>
