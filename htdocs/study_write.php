  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
                  ...
                  <div class="x_content">     
                    <form action = "study_write1.php" method = "post">
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3"  >
                          ...
                          <button type="button" class="btn btn-primary" onclick="location.href='study_list.php'" style="float:right">취소</button>
                        </div>
                      </div>
                    </form>
                    ...
                    <form action = "picture_upload.php" method = "post" enctype = "multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="filebox">
                              ...
                              <p style="margin-left:310px;">강좌의 대표 사진을 첨부해주세요.</p>
                              <!-- <img id="=upload_file"> -->
                        </div>
                      </div>
                    ...
                    <form action = "video_upload4.php" method = "post" enctype = "multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="filebox">
                              <input type = "file" name = "upload" id = 'fileupload' style = "padding-left: 10px;">
                              <p style="margin-left:310px;">강의 영상을 첨부해 주세요.(1GB 이하)</p>
                        </div>
                      </div>
        ...
        <!-- footer content -->
        <footer style="margin-left: 230px;">
