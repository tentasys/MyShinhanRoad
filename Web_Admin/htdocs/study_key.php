              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="javascript:;"> 관리자정보</a></li>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>태그 목록<small>전체 강좌 태그 관리</small></h2>
                    
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <p>태그 : <?php echo $_GET["tag"]; ?></p>
                    <form class="form-horizontal form-label-left">


                      <div class="control-group">
                        <!-- <label class="control-label col-md-3 col-sm-3 col-xs-12">태그 입력</label> -->
            ...
            <button type="button" class="btn btn-round btn-success" onclick="location.href='study_key_write.html'" style="float: right;">태그 등록</button>
          </div>
        </div>
        <!-- /page content -->
